...
public class ProductRepository(ShopDbContext context) : BaseRepository<long, Product>(context), IProductRepository
{
    private readonly ShopDbContext _shopContext = context;
